    ...
    public void importCsv(MultipartFile file) {
        ...
        if (errors.isEmpty()) {
            for (Ticket ticket : tickets) {
                System.out.println("Sauvegarder le ticket");
    ...
    public List<String> importCompleteData (MultipartFile customerFile, MultipartFile budgetFile, MultipartFile depenseFile) {
        ...
        if (errors.isEmpty()) {
            for (CustomerParser customerParser : customerParsers) {
                System.out.println("Invocation de custemer login info");
                ...
                System.out.println("Sauvegarde de customer login info");
        ...
        if (errors.isEmpty()) {
            for (BudgetParser budgetParser : budgetParsers) {
                System.out.println("Sauvegarde du budget");
